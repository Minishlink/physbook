...
class BoquetteService
{
     ...
     *
     * @param  int [$month = null] Mois à chercher. Si $year null, mois de l'année en cours, sinon année $year. Si $month est null, se réferer à year.
     * @param  int [$year  = null]  Année à chercher. Si $year null, cherche depuis toujours.
     *
